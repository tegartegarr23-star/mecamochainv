...
export const BEVERAGE_INGREDIENTS: Ingredient[] = [
  // Raw Beverage Ingredients (Category: Bar)
  { id: 'ing-hou', code: 'HOU', name: 'Houseblend Beans', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 500, current_stock: 3000, is_active: true, cost_per_unit: 180 },
  { id: 'ing-kri', code: 'KRI', name: 'Krimer', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 500, current_stock: 2500, is_active: true, cost_per_unit: 45 },
  { id: 'ing-frm', code: 'FRM', name: 'Indomilk Full Cream UHT', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 1000, current_stock: 5000, is_active: true, cost_per_unit: 20 },
  { id: 'ing-cui', code: 'CUI', name: 'Cup Ice', category_id: 'cat-bar', unit_id: 'u-3', type: 'raw', min_stock: 100, current_stock: 1000, is_active: true, cost_per_unit: 500 },
  { id: 'ing-cul', code: 'CUL', name: 'Cup Lid', category_id: 'cat-bar', unit_id: 'u-3', type: 'raw', min_stock: 100, current_stock: 1000, is_active: true, cost_per_unit: 200 },
  { id: 'ing-acp', code: 'ACP', name: 'Astery Chocolate Powder', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 120 },
  { id: 'ing-gre', code: 'GRE', name: 'Freshmilk', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 1000, current_stock: 5000, is_active: true, cost_per_unit: 22 },
  { id: 'ing-skg', code: 'SKG', name: 'SKM Indomilk', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 1000, current_stock: 4000, is_active: true, cost_per_unit: 25 },
  { id: 'ing-gac', code: 'GAC', name: 'Galon Cleo', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 5000, current_stock: 30000, is_active: true, cost_per_unit: 2 },
  { id: 'ing-shi', code: 'SHI', name: 'Shineroad', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 80 },
  { id: 'ing-ses', code: 'SES', name: 'Sea Salt', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 100, current_stock: 500, is_active: true, cost_per_unit: 50 },
  { id: 'ing-mib', code: 'MIB', name: 'Mix Berries', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 100 },
  { id: 'ing-mat', code: 'MAT', name: 'Madu TJ', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 150 },
  { id: 'ing-toc', code: 'TOC', name: 'Toffico Caramel Syrup', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 120 },
  { id: 'ing-mav', code: 'MAV', name: 'Marjan Vanilla Syrup', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 35 },
  { id: 'ing-tob', code: 'TOB', name: 'Toffico Butterscotch', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 130 },
  { id: 'ing-whs', code: 'WHS', name: 'White Sugar', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 1000, current_stock: 5000, is_active: true, cost_per_unit: 16 },
  { id: 'ing-gaf', code: 'GAF', name: 'Galon All Fresh', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 5000, current_stock: 30000, is_active: true, cost_per_unit: 2 },
  { id: 'ing-drc', code: 'DRC', name: 'Drip Cheese', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 150 },
  { id: 'ing-tep', code: 'TEP', name: 'Teh Poci', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 50 },
  { id: 'ing-teg', code: 'TEG', name: 'Teh Gopek', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 50 },
  { id: 'ing-ted', code: 'TED', name: 'Teh Dandang', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 50 },
  { id: 'ing-tej', code: 'TEJ', name: 'Teh Tongji', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 50 },
  { id: 'ing-sct', code: 'SCT', name: 'Sauce Caramel Toffico', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 140 },
  { id: 'ing-arv', code: 'ARV', name: 'Astery Red Velvet', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 130 },
  { id: 'ing-ast', code: 'AST', name: 'Astery Taro', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 130 },
  { id: 'ing-san', code: 'SAN', name: 'Sanquick', category_id: 'cat-bar', unit_id: 'u-7', type: 'raw', min_stock: 2, current_stock: 10, is_active: true, cost_per_unit: 35000 },
  { id: 'ing-crc', code: 'CRC', name: 'Crumble Caramel', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 80 },
  { id: 'ing-btl', code: 'BTL', name: 'Biskuit Lotus', category_id: 'cat-bar', unit_id: 'u-3', type: 'raw', min_stock: 20, current_stock: 100, is_active: true, cost_per_unit: 1500 },
  { id: 'ing-moc', code: 'MOC', name: 'Morin Chocolate', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 90 },
  { id: 'ing-mal', code: 'MAL', name: 'Marjan Leci', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 35 },
  { id: 'ing-top', code: 'TOP', name: 'Toffico Peppermint', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 120 },
  { id: 'ing-fan', code: 'FAN', name: 'Fanta', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 1000, current_stock: 5000, is_active: true, cost_per_unit: 15 },
  { id: 'ing-man', code: 'MAN', name: 'Marjan Nanas', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 35 },
  { id: 'ing-mas', code: 'MAS', name: 'Marjan Strawberry', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 35 },
  { id: 'ing-mam', code: 'MAM', name: 'Marjan Mangga', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 35 },
  { id: 'ing-pum', code: 'PUM', name: 'Pure Matcha', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 250 },
  { id: 'ing-tos', code: 'TOS', name: 'Toffico Strawberry Puree', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 120 },
  { id: 'ing-bul', code: 'BUL', name: 'Buah Leci', category_id: 'cat-bar', unit_id: 'u-3', type: 'raw', min_stock: 20, current_stock: 100, is_active: true, cost_per_unit: 2000 },
  { id: 'ing-crm', code: 'CRM', name: 'Crumble Matcha', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 90 },
  { id: 'ing-stw', code: 'STW', name: 'Strawberry Segar', category_id: 'cat-bar', unit_id: 'u-3', type: 'raw', min_stock: 20, current_stock: 100, is_active: true, cost_per_unit: 1500 },
  { id: 'ing-mal01', code: 'MAL01', name: 'Marjan Lemon', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 35 },
  { id: 'ing-dib', code: 'DIB', name: 'Diamond Blueberry', category_id: 'cat-bar', unit_id: 'u-2', type: 'raw', min_stock: 200, current_stock: 1000, is_active: true, cost_per_unit: 100 },
  { id: 'ing-toc01', code: 'TOC01', name: 'Popping Candy', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 100, current_stock: 500, is_active: true, cost_per_unit: 200 },
  { id: 'ing-tet', code: 'TET', name: 'Teh Telang', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 100, current_stock: 500, is_active: true, cost_per_unit: 100 },
  { id: 'ing-gua', code: 'GUA', name: 'Gula Aren Balok', category_id: 'cat-bar', unit_id: 'u-1', type: 'raw', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 30 },
  { id: 'ing-egw', code: 'EGW', name: 'Egg White', category_id: 'cat-bar', unit_id: 'u-3', type: 'raw', min_stock: 20, current_stock: 100, is_active: true, cost_per_unit: 2000 },

  // Prepared Beverage Bases (PPB) (Category: Bar)
  { id: 'ing-ppb01', code: 'PPB01', name: 'PP Cold Brew', category_id: 'cat-bar', unit_id: 'u-2', type: 'prepared', min_stock: 1000, current_stock: 5000, is_active: true, cost_per_unit: 25 },
  { id: 'ing-ppb02', code: 'PPB02', name: 'PP Cream Cheese', category_id: 'cat-bar', unit_id: 'u-2', type: 'prepared', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 60 },
  { id: 'ing-ppb03', code: 'PPB03', name: 'PP Kopsu Based', category_id: 'cat-bar', unit_id: 'u-2', type: 'prepared', min_stock: 1000, current_stock: 5000, is_active: true, cost_per_unit: 35 },
  { id: 'ing-ppb04', code: 'PPB04', name: 'PP Tea Based', category_id: 'cat-bar', unit_id: 'u-2', type: 'prepared', min_stock: 1000, current_stock: 5000, is_active: true, cost_per_unit: 10 },
  { id: 'ing-ppb05', code: 'PPB05', name: 'PP Simple Syrup', category_id: 'cat-bar', unit_id: 'u-2', type: 'prepared', min_stock: 1000, current_stock: 5000, is_active: true, cost_per_unit: 15 },
  { id: 'ing-ppb06', code: 'PPB06', name: 'PP Butterfly Pea Based', category_id: 'cat-bar', unit_id: 'u-2', type: 'prepared', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 20 },
  { id: 'ing-ppb07', code: 'PPB07', name: 'PP Palmsugar Based', category_id: 'cat-bar', unit_id: 'u-2', type: 'prepared', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 40 },
  { id: 'ing-ppb08', code: 'PPB08', name: 'PP Kopsu Formula', category_id: 'cat-bar', unit_id: 'u-1', type: 'prepared', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 30 },
  { id: 'ing-ppb09', code: 'PPB09', name: 'PP Destilasi Dirty', category_id: 'cat-bar', unit_id: 'u-2', type: 'prepared', min_stock: 500, current_stock: 2000, is_active: true, cost_per_unit: 50 },
];
